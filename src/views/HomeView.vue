        ...
        <div class="content">
          ...
          <div class="choice" v-show="!userChoice">
            <div @click="play('rock')"><img
                src="https://i.pinimg.com/originals/97/9e/a3/979ea3d4122df7b5c0d051a4af59953f.png" alt=""></div>
            <div @click="play('paper')"><img
                src="https://static.vecteezy.com/system/resources/previews/009/340/337/original/white-crumpled-paper-balls-for-design-element-png.png"
                alt=""></div>
            <div @click="play('scissor')"><img
                src="https://images.vexels.com/media/users/3/177006/isolated/lists/aa415072f3348a3c78b663a307f8ac41-scissors-flat.png"
                alt=""></div>
          </div>
          <div class="loading" v-show="userChoice && loading === true">
            <div><img src="https://pngimg.com/uploads/fist/fist_PNG12.png" alt="">
              <p>You</p>
            </div>
            <p>VS</p>
            <div><img src="https://pngimg.com/uploads/fist/fist_PNG12.png" alt="">
